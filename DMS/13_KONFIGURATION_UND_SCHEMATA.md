...
## Aktueller Einstellungsvertrag 0.4.4 / DEC-050

Persistente Einstellungen weiter in einer bestehenden paper_settings-Zeile; kein zweiter Live-Speicher. Gültig 1–10 Slots und positives Zielnotional, Produkt höchstens 240 USDT. UI verwendet 1-USDT-Schritte; interne Dezimalwerte bleiben kompatibel. 4×45, 5×40 und 10×24 sind gültig; 4×80 bleibt ungültig. Konfigurationsdatei-Startbaseline 3×80 wird nicht umgeschrieben. Gemeinsamer Portfoliobacktest muss die gespeicherte Aufteilung im Manifest nennen, frühere Runs bleiben unverändert.

Der Klick auf Übernehmen sendet den bestehenden technischen Bestätigungsmarker automatisch; es gibt kein Bestätigungswort-Eingabefeld. Legacy emergency_stop bleibt erhalten, aber ohne neue sichtbare Umschaltmöglichkeit; Entfernen der UI ist keine Freigabe eines bestehenden Sicherheitsstopps. Echtgeld-Gates und Einmalbudget bleiben unverändert. Ältere 1–3-UI-Grenzen darunter sind durch DEC-050 ersetzt.
