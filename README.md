...
Aktuell: **Anwendung 0.4.2 / DMS 1.9.0**. Unter Einstellungen sind Binance API-Key und Secret jetzt von Anfang an sichtbar, zunächst gesperrt: lokales Hixton-Passwort festlegen/entsperren, danach Key und Secret eintragen, sicher speichern und Konto prüfen. Neue getrennte Bedienelemente zeigen den 50-USDT-Einmaltest, dessen Stopp und Live an/aus samt tatsächlich gespeicherter Paper-Budgetvorlage. **Echtgeld bleibt gesperrt:** Der signalgesteuerte Einmaltest-Controller ist als Code mit simulierter Börse geprüft, aber produktiver Adapter, automatischer Kontoabgleich und Runtime-Betrieb sind noch nicht angeschlossen/abgenommen. Der Testbutton liefert deshalb ausdrücklich fehlende Freigaben statt einen Kauf. Kein Key schaltet automatisch Echtgeld ein. Anleitung und offene Fortsetzung: [DMS 20](DMS/20_BETRIEBSRUNBOOK.md#live-vorbereitung-ab-anwendung-040).
