...
Aktuell: **Anwendung 0.4.1 / DMS 1.8.2**. Die Paper-Einstellungen lassen sich ohne Zurückspringen bearbeiten und beispielsweise mit 1×50 USDT speichern; Bestätigungen funktionieren direkt auf der Seite ohne native Browserdialoge. Die **Live-Vorbereitung** enthält lokalen Passwortschutz, Windows-Schlüsselablage und ausschließlich lesende Binance-Kontoprüfung. Ein zusätzlicher Orderjournal-Kern ist nur mit einer simulierten Börse getestet und nicht an UI/Binance angeschlossen. **Live bleibt gesperrt**, solange produktive Order-/Fill-/Reconciliation-Implementierung und DMS-Abnahme fehlen. Das bloße Eintragen eines Keys hebt keine Sperre auf. DEC-047 legt jetzt den gewünschten Echtgeld-Einmaltest fest: auf ein neues Hixton-Signal aus zehn Coins warten, einmal 50 USDT Kaufnotional einsetzen, den regulären Coin-Strategieausstieg abwarten und danach stoppen. **Spezifiziert, noch nicht startbar.** Anleitung, Gebührenabgrenzung, tatsächliche Stop-/Take-Profit-Regeln und offene Arbeiten: [DMS 20](DMS/20_BETRIEBSRUNBOOK.md#live-vorbereitung-ab-anwendung-040).
