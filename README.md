...
Aktuell: **Anwendung 0.4.3 / DMS 1.9.1**. Eine gemeinsame Handelskonfiguration für Paper und den späteren normalen Livebetrieb: Slots, Positionsgröße und Einstiegspause nur einmal einstellen und mit ANWENDEN speichern. Die Live-Zusammenfassung zeigt sofort den Entwurf und getrennt den gültigen Speicherstand; kein fest verdrahtetes 3×80-Budget. Aktuell freigegebene Grenze bleibt 3 Slots / 240 USDT; vier oder fünf Slots benötigen eine ausdrückliche Erweiterung und ausreichendes Guthaben. Paper nutzt echte Marktdaten in Echtzeit mit simuliertem Geld/Fills, Live dieselbe Handelslogik mit echten Orders und getrenntem Konto. Nur der Backtest spielt historische Zeit ab; identische Fills sind nicht garantiert.

Binance API-Key/Secret bleiben sichtbar, bis zur lokalen Entsperrung deaktiviert. Einmaltest bleibt die ausdrückliche Ausnahme 1×50; ein einziger „Live aus“-Button sperrt neue Echtgeld-Einstiege einschließlich Einmaltest, ohne offene Positionen zu liquidieren. **Echtgeld bleibt technisch gesperrt:** Produktiver Adapter, Kontoabgleich und Runtime-Anschluss fehlen weiterhin. Diese UI-Korrektur ist keine Live-Abnahme. Anleitung und offene Fortsetzung: [DMS 20](DMS/20_BETRIEBSRUNBOOK.md).
